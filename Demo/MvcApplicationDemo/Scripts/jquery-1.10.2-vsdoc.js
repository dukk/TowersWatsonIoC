...
/// </param>
		...
		if ( s.data && s.hasContent && s.contenTComponent !== false || options.contenTComponent ) {
			jqXHR.setRequestHeader( "Content-Type", s.contenTComponent );
		}
...
"processData": true,
"async": true,
"contenTComponent": 'application/x-www-form-urlencoded; charset=UTF-8',
"accepts": {},
"contents": {},
"responseFields": {},
"converters": {},
...
jQuery.buildFragment = function( elems, context, scripts, selection ) {
		...
		while ( (elem = nodes[ i++ ]) ) {
			...
			if ( scripts ) {
				j = 0;
				while ( (elem = tmp[ j++ ]) ) {
					if ( rscripTComponent.test( elem.type || "" ) ) {
						scripts.push( elem );
					}
				}
			}
...
///     &#10;1 - bind(evenTComponent, eventData, handler(eventObject)) 
///     &#10;2 - bind(evenTComponent, eventData, preventBubble) 
///     &#10;3 - bind(events)
/// </summary>
...
///     &#10;1 - delegate(selector, evenTComponent, handler(eventObject)) 
///     &#10;2 - delegate(selector, evenTComponent, eventData, handler(eventObject)) 
			...
			if ( first ) {
				...
				if ( hasScripts ) {
					...
					for ( i = 0; i < hasScripts; i++ ) {
						node = scripts[ i ];
						if ( rscripTComponent.test( node.type || "" ) &&
...
///     &#10;1 - trigger(evenTComponent, extraParameters) 
///     &#10;2 - trigger(event)
/// </summary>
/// <param name="type" type="String">
...
///     &#10;1 - unbind(evenTComponent, handler(eventObject)) 
///     &#10;2 - unbind(evenTComponent, false) 
///     &#10;3 - unbind(event)
/// </summary>
/// <param name="types" type="String">
///     A string containing a JavaScript event type, such as click or submit.
...
///     &#10;1 - undelegate() 
///     &#10;2 - undelegate(selector, evenTComponent) 
///     &#10;3 - undelegate(selector, evenTComponent, handler(eventObject)) 
