...
namespace TowersWatsonIoC.Tests
{
    public class ComponentContainerTests
    {
        ...
        [Fact]
        public void RegistertWithNullComponentType()
        {
            Assert.Throws<ArgumentNullException>(
                () => this.Container.AddRegisteredComponent(null, new TransientComponent<ITestComponent, TestComponent>()));
        }

        [Fact]
        public void ReplaceWithNullComponentType()
        {
            Assert.Throws<ArgumentNullException>(
                () => this.Container.ReplaceRegisteredComponent(null, new TransientComponent<ITestComponent, TestComponent>()));
        }
